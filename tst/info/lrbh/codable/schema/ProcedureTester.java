...
public class ProcedureTester
{
  ...
  private static final Procedure newby = new Procedure ();
  ...
  {
    assert newby.hashCode () == new Procedure ().hashCode (): "not " + newby.hashCode () + " == " + new Procedure ().hashCode ();
    show (".");
  }
  ...
  private static void testEquals ()
  {
    ...
    assert newby.equals (new Procedure ()): "not " + newby + " equals " + new Procedure ();
    show (".");
  }
