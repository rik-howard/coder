...
public class Xemplate
{


  // ----------------------------------------------------------------------------------- predicate

  public static Boolean isXemplateLine (String xtring) {return xtring.trim ().startsWith (tip);}
  ...
  //public static String xleanXariable (String xoken) {return isXariable (xoken)? debracketed (xoken): null;}
