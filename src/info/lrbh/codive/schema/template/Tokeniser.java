...
public class Tokeniser
{
  ...
  private static final List <Token> union (Token token, List <Token> tokenz)
  {
    List <Token> union = new ArrayList <Token> ();
    if (token != null) union.add (token);
    if (tokenz != null) union.addAll (tokenz);
    return union;
  }
